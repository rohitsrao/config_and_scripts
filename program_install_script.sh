...
sudo apt install -yy build-essential curl vim git timeshift vlc tracker htop net-tools texlive-latex-extra texlive-lang-german texlive-science texmaker gnome-tweaks locate nodejs npm youtube-dl libreoffice-writer libreoffice-calc
