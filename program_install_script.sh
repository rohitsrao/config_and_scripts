...
sudo apt install -yy build-essential curl vim git timeshift vlc tracker htop net-tools texlive-latex-extra texmaker gnome-tweaks owncloud-client locate nodejs npm youtube-dl
